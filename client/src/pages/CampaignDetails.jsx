...
//             <div clasName="mt-[20px] flex flex-col p-4 bg-[#1c1c43] rounded-[10px]">
...
//                       <h4 className="font-epilogue font-semibold text-[14px] leading-[22px] text-white ">Help It, because you believe in it.</h4>
...
import { calculateBarPercentage, daysLeft } from '../utils';
import { profile_icon, thirdweb } from '../assets';
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        <div className="flex-[2] flex flex-col gap-[40px]">
          <div>
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
              <div className="w-[52px] h-[52px] flex items-center justify-center rounded-full bg-[#2c2f32] cursor-pointer">
                <img src={profile_icon} alt="user" className="w-[60%] h-[60%] object-contain"/>
              </div>
              <div>
                <h4 className="font-epilogue font-semibold text-[14px] text-white break-all">{state.owner}</h4>
                {/* <p className="mt-[4px] font-epilogue font-normal text-[12px] text-[#808191]">10 Campaigns</p> */}
